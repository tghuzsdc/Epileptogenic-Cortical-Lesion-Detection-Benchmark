...
from torch.nn import Module as SegmentationNetwork  # [unified] drop nnU-Net v1 base class
...
class U_ResTran3D(nn.Module):
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', img_size=None, num_classes=None, weight_std=False,
                 in_channels=1):  # [unified] in_channels was hard-coded to 1
        ...
        self.backbone = CNNBackbone.Backbone(depth=9, in_channels=in_channels, norm_cfg=norm_cfg,  # [unified]
